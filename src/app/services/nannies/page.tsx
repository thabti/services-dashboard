...
import { useNanniesData } from "@/lib/hooks/use-nannies-data";

export default function NanniesServicePage() {
  const {
    stats,
    chartData,
    earningData,
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-6">
        <Header title="Nanny Services" subtitle="Analytics for nanny orders" />
      </div>
